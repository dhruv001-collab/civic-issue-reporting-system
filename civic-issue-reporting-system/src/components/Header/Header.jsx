...
const Nav = () => {
  ...
  return (
    <>
      <nav
        className={`bg-white shadow-md px-3 lg:px-12 sticky top-0 left-0 w-full z-30 ${
          isScrolled ? "bg-white/60 backdrop-blur-sm shadow-md" : "bg-white"
        }`}
      >
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center">
            <div
              className="h-[100px] w-[120px] sm:h-[70px] sm:w-[160px] lg:h-[100px] lg:w-[180px] "
              onClick={() => navigate("/")}
            >
              <img
                src={logo}
