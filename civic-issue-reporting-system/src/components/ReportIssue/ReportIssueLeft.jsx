    ...
    return (
      <div className='min-w-full max-w-md bg-white p-6 flex flex-col gap-2  rounded-2xl shadow-xl'>
        ...
        <div>
          ...
          <input value={issueDetails.Issue_title} name='Issue_title' onChange={changeHandler} className='w-160 border bg-gray hover:bg-white border-black rounded-md h-8 pl-2 text-[14px]' type="text" placeholder='Enter Title' />
        </div>

        <div>
          <h2 className='font-medium'>Category <span className='text-red-400 text-xl'>*</span></h2>

          <input value={issueDetails.category} name='category' onChange={changeHandler} className='w-160 border bg-gray hover:bg-white border-black rounded-md h-8 pl-2 text-[14px]' type="text" placeholder='Select a category' />
        </div>

        <div>
          <h2 className='font-medium'>Location <span className='text-red-400 text-xl'>*</span></h2>
          <input value={issueDetails.location} name='location' onChange={changeHandler} className='w-160 border bg-gray hover:bg-white border-black rounded-md h-8 pl-2 text-[14px]' type="text" placeholder='Street address or nearby landmark' />
        </div>

        <div>
          <h2 className='font-medium'>Description <span className='text-red-400 text-xl'>*</span></h2>
          <input value={issueDetails.description} name='description' onChange={changeHandler} className='w-160 border bg-gray hover:bg-white border-black rounded-md h-8 pl-2 text-[14px]' type="text" placeholder='Provide a detailed description' />
        </div>
